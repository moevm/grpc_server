...
class TestIntegration(unittest.TestCase):
    ...
    def test_bad_sites(self):
        ...
        self.assertEqual(data['statistics']['no_ports_count'] + data['statistics']['timeout'] + data['statistics']['error'], 20)
    ...
    def test_mixed_sites(self):
        ...
        self.assertGreater(data['statistics']['timeout'] + data['statistics']['error'] + data['statistics']['no_ports_count'], 0)
        
        self.assertEqual(data['statistics']['success'] + data['statistics']['timeout'] + 
                data['statistics']['error'] + data['statistics']['no_ports_count'], data['statistics']['total'])
