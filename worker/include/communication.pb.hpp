...
constexpr PulseType PulseType_MAX = static_cast<PulseType>(3);
constexpr int PulseType_ARRAYSIZE = 3 + 1;
...
constexpr ControllerError ControllerError_MAX = static_cast<ControllerError>(3);
constexpr int ControllerError_ARRAYSIZE = 3 + 1;
const ::google::protobuf::EnumDescriptor*
...
constexpr ControlType ControlType_MAX = static_cast<ControlType>(3);
constexpr int ControlType_ARRAYSIZE = 3 + 1;
const ::google::protobuf::EnumDescriptor*
...
constexpr WorkerError WorkerError_MAX = static_cast<WorkerError>(4);
constexpr int WorkerError_ARRAYSIZE = 4 + 1;
const ::google::protobuf::EnumDescriptor*
...
// optional uint64 worker_id = 2;
inline bool PulseResponse::has_worker_id() const {
...
// optional uint64 task_id = 3;
inline bool ControlMsg::has_task_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
